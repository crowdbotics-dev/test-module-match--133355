"""
Django settings for test_module_match__133355 project.
...
ROOT_URLCONF = 'test_module_match__133355.urls'
...
WSGI_APPLICATION = 'test_module_match__133355.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "test_module_match__133355 API",
    "DESCRIPTION": "API documentation for test_module_match__133355 App",
    "VERSION": "v1",
}
